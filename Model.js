...
// ---------------------------------------------------------------- theme css
//
// Teams V2 is a Fluent UI v9 app, and Fluent v9 draws almost everything from
// CSS custom properties on :root. Overriding that token set is therefore the
// honest lever available from outside the app: it retints the surfaces, text,
// and brand accents that Fluent actually reads. Anything Teams hardcodes
// outside the token system stays as Microsoft shipped it.
...
function themeCss(theme) {
  ...
  lines.push(":root, body, .app, [data-theme] {")
  lines.push("  --colorNeutralBackground1: " + s1 + ";")
  lines.push("  --colorNeutralBackground1Hover: " + s2 + ";")
  lines.push("  --colorNeutralBackground1Pressed: " + s3 + ";")
  lines.push("  --colorNeutralBackground1Selected: " + s3 + ";")
  lines.push("  --colorNeutralBackground2: " + s2 + ";")
  lines.push("  --colorNeutralBackground3: " + s3 + ";")
  lines.push("  --colorNeutralBackground4: " + s4 + ";")
  lines.push("  --colorNeutralBackground5: " + s5 + ";")
  lines.push("  --colorNeutralBackground6: " + s4 + ";")
  lines.push("  --colorNeutralBackgroundInverted: " + fg + ";")
  lines.push("  --colorNeutralBackgroundStatic: " + s3 + ";")
  lines.push("  --colorSubtleBackground: transparent;")
  lines.push("  --colorSubtleBackgroundHover: " + rgba(fg, 0.08) + ";")
  lines.push("  --colorSubtleBackgroundPressed: " + rgba(fg, 0.12) + ";")
  lines.push("  --colorSubtleBackgroundSelected: " + rgba(accent, 0.16) + ";")
  lines.push("")
  lines.push("  --colorNeutralForeground1: " + fg + ";")
  lines.push("  --colorNeutralForeground1Hover: " + fg + ";")
  lines.push("  --colorNeutralForeground1Static: " + fg + ";")
  lines.push("  --colorNeutralForeground2: " + fg2 + ";")
  lines.push("  --colorNeutralForeground2Hover: " + fg + ";")
  lines.push("  --colorNeutralForeground3: " + fg3 + ";")
  lines.push("  --colorNeutralForeground4: " + fg4 + ";")
  lines.push("  --colorNeutralForegroundDisabled: " + fg4 + ";")
  lines.push("  --colorNeutralForegroundInverted: " + bg + ";")
  lines.push("  --colorNeutralForegroundOnBrand: " + onAccent + ";")
  lines.push("")
  lines.push("  --colorNeutralStroke1: " + stroke + ";")
  lines.push("  --colorNeutralStroke2: " + strokeSoft + ";")
  lines.push("  --colorNeutralStroke3: " + strokeSoft + ";")
  lines.push("  --colorNeutralStrokeAccessible: " + fg3 + ";")
  lines.push("  --colorTransparentStroke: transparent;")
  lines.push("")
  lines.push("  --colorBrandBackground: " + accent + ";")
  lines.push("  --colorBrandBackgroundHover: " + accentHover + ";")
  lines.push("  --colorBrandBackgroundPressed: " + accentPressed + ";")
  lines.push("  --colorBrandBackgroundSelected: " + accentHover + ";")
  lines.push("  --colorBrandBackground2: " + rgba(accent, 0.16) + ";")
  lines.push("  --colorBrandBackgroundStatic: " + accent + ";")
  lines.push("  --colorBrandForeground1: " + accent + ";")
  lines.push("  --colorBrandForeground2: " + accentHover + ";")
  lines.push("  --colorBrandForegroundLink: " + accent + ";")
  lines.push("  --colorBrandForegroundLinkHover: " + accentHover + ";")
  lines.push("  --colorBrandStroke1: " + accent + ";")
  lines.push("  --colorBrandStroke2: " + rgba(accent, 0.4) + ";")
  lines.push("  --colorCompoundBrandBackground: " + accent + ";")
  lines.push("  --colorCompoundBrandBackgroundHover: " + accentHover + ";")
  lines.push("  --colorCompoundBrandForeground1: " + accent + ";")
  lines.push("  --colorCompoundBrandStroke: " + accent + ";")
  lines.push("")
  lines.push("  --colorNeutralShadowAmbient: " + rgba("#000000", dark ? 0.5 : 0.12) + ";")
  lines.push("  --colorNeutralShadowKey: " + rgba("#000000", dark ? 0.6 : 0.16) + ";")
  if (radius > 0) {
    lines.push("  --borderRadiusMedium: " + Math.min(radius, 8) + "px;")
    lines.push("  --borderRadiusLarge: " + Math.min(radius, 12) + "px;")
    lines.push("  --borderRadiusXLarge: " + radius + "px;")
  }
  lines.push("}")
  lines.push("")
  ...
  if (theme.fontFamily) {
    ...
    lines.push(":root { --fontFamilyBase: " + JSON.stringify(String(theme.fontFamily))
